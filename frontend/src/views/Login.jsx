    ...
    <div className="min-h-screen flex flex-col justify-between bg-slate-50 relative overflow-hidden font-sans">
      ...
      <main className="relative z-10 flex-1 flex flex-col justify-center items-center px-4 py-6">
        <div className="w-full max-w-md">
          ...
          {/* Tarjeta de Login */}
          <div className="rounded-2xl p-8 bg-white/45 backdrop-blur-md border border-white/20 shadow-md">
            ...
            {/* Títulos */}
            <h2 className="text-2xl font-bold text-slate-900 text-center mb-1 font-serif">
              Iniciar sesión
            </h2>
            <p className="text-sm text-slate-800 font-medium text-center mb-6">
            ...
            <form onSubmit={handleCustomLogin} className="space-y-4">
              ...
              <button
                type="submit"
                disabled={submitting}
                className="w-full py-3 px-4 text-white font-semibold rounded-xl flex items-center justify-center gap-2 cursor-pointer disabled:opacity-50 bg-[#6b0060]/75 transition-colors duration-200 hover:bg-[#52004a] shadow-sm"
              >
